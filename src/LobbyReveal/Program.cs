    ...
    internal class Program
    {
        ...
        private static void Refresh()
        {
            while (true)
            {
                ...
                {
                    Console.Clear();
                    AnsiConsole.Write(new Markup("LobbyView+Dodge")
                        .Centered());
                    AnsiConsole.Write(new Markup("@Siyarbekir47").Centered());
                    Console.WriteLine();
                    Console.WriteLine();
                    ...
                    Console.WriteLine();
                    Console.WriteLine();
                    AnsiConsole.Write(new Markup("[u][cyan][b]Schreib Nummer für Op.gg![/][/][/]")
                        .LeftJustified());
                    Console.WriteLine();
                    _update = false;
                }
